...
Open `http://localhost:3000`, optionally select `reset-password.html` from the file picker, and submit:

> "How do I reset my password?"

The agent will reason through the UI file, call tools to find the relevant elements, and return a 7-step instruction list with CSS selectors.